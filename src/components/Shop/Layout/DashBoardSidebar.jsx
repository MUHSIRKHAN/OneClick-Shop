...
const DashBoardSidebar = ({active}) => {
  return (
    <div className='w-full h[89vh] bg-[##f5f6fb]] shadow-sm overflow-y-scroll sticky top-0 left-0 z-10'>
        {/*single item*/}
...
<div className='w-full flex items-center p-4'>
    <Link to="/dashboard-products" className='w-full flex items-center'>
        ...
        <h5 className={`hidden 800px:block only:pl-2 text-[18px] font-[400] ${active===3 ? "text-[crimson]":"text-[#555]"}`}>
            All products
